...
// ---------------------------------------------------
	...
	void GpuBus::TransferToGpu( VkImage target, VkImageSubresourceLayers subresource, VkOffset3D targetOffset, VkExtent3D targetExtent ) {
...
// ---------------------------------------------------
	...
	void GpuBus::TransferToGpu( VkBuffer target, VkDeviceSize targetOffset, VkDeviceSize targetExtent ) {
		VkDeviceSize	stagingOffset;
...
// ---------------------------------------------------
	...
	void GpuBus::TransferToHost( VkImage source, VkImageSubresourceLayers subresource, VkOffset3D sourceOffset, VkExtent3D sourceExtent ) {
		VkDeviceSize	stagingOffset;
...
// ---------------------------------------------------
	...
	void GpuBus::TransferToHost( VkBuffer source, VkDeviceSize sourceOffset, VkDeviceSize sourceExtent ) {
		VkDeviceSize stagingOffset;
...
// ---------------------------------------------------
	...
	bool GpuBus::CheckCommandsConsumed( Gpu& gpu ) const {
		return vkWaitForFences( gpu, 1u, &_commandsConsumed, VK_FALSE, 0u ) != VK_TIMEOUT;
	}

// ---------------------------------------------------

	VkResult GpuBus::SubmitCommands( Gpu& gpu ) {
...
// ---------------------------------------------------
	...
	VkResult GpuBus::BindResources( Gpu& gpu, GpuHeap& heap, VkDeviceSize transferBufferSize ) {
...
// ---------------------------------------------------
	...
	void GpuBus::FreeResources( Gpu& gpu, GpuHeap& heap ) {
...
// ---------------------------------------------------
	...
	void Swap( GpuBus& builder0, GpuBus& builder1 ) {
		using ::Eldritch2::Swap;
