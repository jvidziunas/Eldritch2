...
// ---------------------------------------------------
	...
	ETInlineHint Light::Light( Transformation localToWorld, RgbColor color, float16 radius ) : localToWorld( localToWorld ), color( color ), radius( radius ) {}

// ---------------------------------------------------

	ETInlineHint GraphicsScene::LeafExtractor::LeafExtractor( Vector cellLength ) : _inverseCellLength( Vector( 1.0f, 1.0f, 1.0f, 1.0f ) / cellLength ) {}
