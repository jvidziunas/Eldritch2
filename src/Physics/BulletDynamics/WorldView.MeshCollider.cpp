...
// ---------------------------------------------------
	...
	WorldView::MeshCollider::MeshCollider( const MeshResourceView& asset, WorldView& owningView ) {
...
// ---------------------------------------------------
	...
	void WorldView::MeshCollider::SetEnabled( bool value /*= true*/ ) {
...
// ---------------------------------------------------
	...
	ETNoAliasHint void WorldView::MeshCollider::ExposeScriptAPI( Scripting::ScriptApiRegistrationInitializationVisitor& /*typeRegistrar*/ ) {}
