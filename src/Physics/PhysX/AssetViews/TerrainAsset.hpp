...
namespace AssetViews {
	...
	/*!	@param[in] assetPath Null-terminated, UTF-8-encoded character sequence containing the file system path to the asset the @ref TerrainAsset will be describing. */
