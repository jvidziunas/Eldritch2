...
// ---------------------------------------------------
	...
	class Direct3D11BufferBuilder : public Utility::Noncopyable {
	// - CONSTRUCTOR/DESTRUCTOR --------------------------

	public:
		// Constructs this Direct3D11BufferBuilder instance.
		Direct3D11BufferBuilder();

		// Destroys this Direct3D11BufferBuilder instance.
		~Direct3D11BufferBuilder();
	...
	// ---------------------------------------------------
		...
		Renderer::Direct3D11BufferBuilder&	SetIndexBuffer( size_t elementCount, bool force32BitIndices = false );
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetVertexBuffer( size_t elementCount, size_t vertexSize );
		...
		// with the specified number of elements.
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetGenericBuffer( size_t elementCount, size_t elementSize );
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetStructuredBuffer( size_t elementCount, size_t structureSize );
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetConstantBuffer( size_t structureSize );
	...
	// ---------------------------------------------------
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetAllowsIndirectDrawCall( bool enabled = true );
	...
	// ---------------------------------------------------
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetInitialData( const void* dataPtr );
	...
	// ---------------------------------------------------
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetDebugName( const char* name );
	...
	// ---------------------------------------------------
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetDynamic( bool write = true, bool read = false );
	...
	// ---------------------------------------------------
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetNeedsSRV( bool needsSRV = true );
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetSRVFormat( ::DXGI_FORMAT format );
	...
	// ---------------------------------------------------
		...
		// used as a standard vertex stream input.
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetNeedsUAV( bool needsUAV = true, bool appendBuffer = false );
		...
		// A reference to (*this) is returned, allowing method invocations to be chained.
		Renderer::Direct3D11BufferBuilder&	SetUAVFormat( ::DXGI_FORMAT format );
