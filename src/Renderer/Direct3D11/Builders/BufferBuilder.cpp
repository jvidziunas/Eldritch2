...
// INCLUDES
//==================================================================//
#include <Renderer/Direct3D11/Builders/BufferBuilder.hpp>
...
namespace Direct3D11 {
	...
	BufferBuilder::BufferBuilder() : _initialData( nullptr ),
									 _bufferSize( 0u ),
									 _structureSize( 0u ),
									 _elementCount( 0u ),
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetIndexBuffer( size_t elementCount, bool force32BitIndices ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetGenericBuffer( size_t elementCount, size_t elementSize ) {
		_bufferSize		= elementSize * elementCount;
		_elementCount	= elementCount;
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetVertexBuffer( size_t elementCount, size_t vertexSize ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetStructuredBuffer( size_t elementCount, size_t structureSize ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetConstantBuffer( size_t structureSize ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetAllowsIndirectDrawCall( bool enabled ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetInitialData( const void* dataPtr ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetDynamic( bool write, bool read ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetNeedsSRV( bool needsSRV ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetNeedsUAV( bool needsUAV, bool appendBuffer ) {
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetUAVFormat( ::DXGI_FORMAT format ) {
		_uavFormat = format;
		return( *this );
	}
...
// ---------------------------------------------------
	...
	BufferBuilder& BufferBuilder::SetSRVFormat( ::DXGI_FORMAT format ) {
		_srvFormat = format;
...
// ---------------------------------------------------
	...
	ErrorCode BufferBuilder::Compile( ID3D11Device* const device ) {
...
// ---------------------------------------------------
	...
	ErrorCode BufferBuilder::Compile( const COMPointer<ID3D11Device>& device ) {
		return Compile( device.GetUnadornedPointer() );
	}

// ---------------------------------------------------

	const COMPointer<::ID3D11Buffer>& BufferBuilder::GetBuffer() const {
		return _out;
	}

// ---------------------------------------------------

	const COMPointer<::ID3D11ShaderResourceView>& BufferBuilder::GetShaderResourceView() const {
		return _outView;
	}

// ---------------------------------------------------

	const COMPointer<::ID3D11UnorderedAccessView>& BufferBuilder::GetUnorderedAccessView() const {
		return _outUnorderedAccessView;
	}

// ---------------------------------------------------

	BufferBuilder& BufferBuilder::SetDebugName( const char* name ) {
#	if( ET_DEBUG_MODE_ENABLED )
		_debugName = name;
#	else
