...
namespace Recast {
	...
	BipedalAgent::BipedalAgent( Armature& armature ) : _armature( &armature ), _scene( nullptr ), _id( NavigationScene::InvalidAgentId ) {}
...
// ---------------------------------------------------
	...
	bool ETSimdCall BipedalAgent::BeginNavigation( NavigationScene& scene, Vector targetPosition ) {
