...
// ---------------------------------------------------
	...
	ETPureFunctionHint Float4x4 Float4x4::Perspective( const RadianMeasure horizontalFieldOfView, const float32 aspect, const float32 near, const float32 far ) {
		return Perspective( horizontalFieldOfView, RadianMeasure( horizontalFieldOfView * aspect ), near, far );
	}

// ---------------------------------------------------

	ETPureFunctionHint Float4x4 Float4x4::Perspective( const RadianMeasure horizontalFieldOfView, const RadianMeasure verticalFieldOfView, const float32 near, const float32 far ) {
...
// ---------------------------------------------------
	...
	ETPureFunctionHint Float4x4 Float4x4::Rotation( const Quaternion orientation ) {
...
// ---------------------------------------------------
	...
	ETPureFunctionHint Float4x4 Float4x4::RigidTransformation( const Float4 translation, const Quaternion orientation ) {
...
// ---------------------------------------------------
	...
	ETPureFunctionHint Float4x4 Float4x4::RigidTransformation( const RigidTransform transform ) {
		return RigidTransformation( transform.translation, transform.orientation );
	}

// ---------------------------------------------------

	ETPureFunctionHint Float4x4 Float4x4::Identity() {
...
#endif
	ETPureFunctionHint Float4x4 Float4x4::Zero() {
		Float4x4	temp;
