...
// ---------------------------------------------------
	...
	ETForceInlineHint Float4x4::Float4x4( const ::Eldritch2::Float4 values[4] ) {
...
// ---------------------------------------------------
	...
	ETForceInlineHint Float4x4::Float4x4( const ::Eldritch2::Float4 row0, const ::Eldritch2::Float4 row1, const ::Eldritch2::Float4 row2, const ::Eldritch2::Float4 row3 ) {
...
// ---------------------------------------------------
	...
	ETForceInlineHint Float4x4::Float4x4( const ::Eldritch2::float32 m00, const ::Eldritch2::float32 m01, const ::Eldritch2::float32 m02, const ::Eldritch2::float32 m03,
...
// ---------------------------------------------------
	...
	ETForceInlineHint ETNoAliasHint ::Eldritch2::Float4x4 operator *( const ::Eldritch2::float32 scalar, const ::Eldritch2::Float4x4 operand ) {
...
// ---------------------------------------------------
	...
	// ---
		...
		__m128		operandRows[4] = { ::_mm_loadu_ps( operand1.elements[0] ), ::_mm_loadu_ps( operand1.elements[1] ), ::_mm_loadu_ps( operand1.elements[2] ), ::_mm_loadu_ps( operand1.elements[3] ) };
...
// ---------------------------------------------------
	...
	ETForceInlineHint ::Eldritch2::Float4x4& Float4x4::operator +=( const ::Eldritch2::Float4x4 operand ) {
...
// ---------------------------------------------------
	...
	ETForceInlineHint ::Eldritch2::Float4x4& Float4x4::operator *=( const ::Eldritch2::float32 scalar ) {
		const __m128	scaleVector( ::_mm_set_ps1( scalar ) );
...
// ---------------------------------------------------
	...
	ETForceInlineHint ::Eldritch2::Float4x4& Float4x4::operator *=( const ::Eldritch2::Float4x4 matrix ) {
		enum : int {
			ALL_SOURCE_COMPONENTS	= 0xF0,
			X_MASK					= ALL_SOURCE_COMPONENTS | 0x01,
			Y_MASK					= ALL_SOURCE_COMPONENTS | 0x02,
	...
	// ---
		...
		// Prepare the operand by performing a matrix transpose.
		__m128	operandRows[4] = { ::_mm_loadu_ps( matrix.elements[0] ), ::_mm_loadu_ps( matrix.elements[1] ), ::_mm_loadu_ps( matrix.elements[2] ), ::_mm_loadu_ps( matrix.elements[3] ) };
		_MM_TRANSPOSE4_PS( operandRows[0], operandRows[1], operandRows[2], operandRows[3] );
