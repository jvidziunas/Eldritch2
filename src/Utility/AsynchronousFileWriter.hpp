...
// ---------------------------------------------------
	...
	public:
		...
		// - DATA MEMBERS ------------------------------------
			...
			// Amount of data successfully written before a failure case, or the original
	...
	protected:
		// Constructs this AsynchronousFileWriter instance.
		AsynchronousFileWriter();

	public:
		// Destroys this AsynchronousFileWriter instance.
		virtual ~AsynchronousFileWriter();
	};
