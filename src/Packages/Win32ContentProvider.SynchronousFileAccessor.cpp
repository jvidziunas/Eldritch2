/*==================================================================*\
  Win32ContentProvider.SynchronousFileAccessor.cpp
  ------------------------------------------------------------------
  Purpose:
...
namespace FileSystem {
	...
	Win32ContentProvider::SynchronousFileAccessor::SynchronousFileAccessor( const ::HANDLE fileHandle, const size_t mediaSectorSizeInBytes ) : _fileHandle( fileHandle ), _mediaSectorSizeInBytes( mediaSectorSizeInBytes ) {}

// ---------------------------------------------------

	Win32ContentProvider::SynchronousFileAccessor::~SynchronousFileAccessor() {
		::CloseHandle( _fileHandle );
	}

// ---------------------------------------------------

	SynchronousFileReader::BlockingResult Win32ContentProvider::SynchronousFileAccessor::Read( void* const destinationBuffer, const size_t lengthToReadInBytes )  {
		enum : size_t {
...
// ---------------------------------------------------
	...
	SynchronousFileReader::BlockingResult Win32ContentProvider::SynchronousFileAccessor::Read( void* const destinationBuffer, const size_t lengthToReadInBytes, const uint64 fileOffsetInBytes ) {
...
// ---------------------------------------------------
	...
	SynchronousFileWriter::BlockingResult Win32ContentProvider::SynchronousFileAccessor::Write( const void* const sourceBuffer, const size_t lengthToWriteInBytes ) {
		enum : size_t {
...
// ---------------------------------------------------
	...
	SynchronousFileWriter::BlockingResult Win32ContentProvider::SynchronousFileAccessor::Write( const void* const sourceBuffer, const size_t lengthToWriteInBytes, const uint64 fileOffsetInBytes ) {
		::LARGE_INTEGER	fileOffsetHelper;
		::LARGE_INTEGER	tempOffset;
...
// ---------------------------------------------------
	...
	void Win32ContentProvider::SynchronousFileAccessor::AdvanceToEnd() {
		::LARGE_INTEGER	fileOffsetHelper;
		::LARGE_INTEGER	tempOffset;
...
// ---------------------------------------------------
	...
	void Win32ContentProvider::SynchronousFileAccessor::SetFileSize( const uint64 fileSizeInBytes ) {
		::LARGE_INTEGER	fileOffsetHelper;
		::LARGE_INTEGER	tempOffset;
...
// ---------------------------------------------------
	...
	uint64 Win32ContentProvider::SynchronousFileAccessor::GetFileCursorInBytes() const {
...
// ---------------------------------------------------
	...
	uint64 Win32ContentProvider::SynchronousFileAccessor::GetSizeInBytes() const {
...
// ---------------------------------------------------
	...
	size_t Win32ContentProvider::SynchronousFileAccessor::GetPhysicalMediaSectorSizeInBytes() const {
