/*==================================================================*\
  Win32ContentProvider.AsynchronousFileAccessor.cpp
  ------------------------------------------------------------------
  Purpose:
...
namespace FileSystem {
	...
	Win32ContentProvider::AsynchronousFileAccessor::AsynchronousFileAccessor( const ::HANDLE fileHandle, const size_t mediaSectorSizeInBytes ) : _fileHandle( fileHandle ), _mediaSectorSizeInBytes( mediaSectorSizeInBytes ) {
...
// ---------------------------------------------------
	...
	Win32ContentProvider::AsynchronousFileAccessor::~AsynchronousFileAccessor() {
...
// ---------------------------------------------------
	...
	ErrorCode Win32ContentProvider::AsynchronousFileAccessor::BeginRead( void* destinationBuffer, size_t lengthToReadInBytes, uint64 fileOffsetInBytes ) {
...
// ---------------------------------------------------
	...
	ErrorCode Win32ContentProvider::AsynchronousFileAccessor::BeginWrite( const void* sourceBuffer, size_t lengthToWriteInBytes, uint64 fileOffsetInBytes ) {
		::LARGE_INTEGER&	fileOffsetHelper( reinterpret_cast<::LARGE_INTEGER&>( _overlapped.Offset ) );
...
// ---------------------------------------------------
	...
	bool Win32ContentProvider::AsynchronousFileAccessor::IsReadComplete() {
		::DWORD	readBytes( 0u );
...
// ---------------------------------------------------
	...
	bool Win32ContentProvider::AsynchronousFileAccessor::IsWriteComplete() {
...
// ---------------------------------------------------
	...
	AsynchronousFileReader::BlockingResult Win32ContentProvider::AsynchronousFileAccessor::BlockUntilReadComplete() {
		::DWORD			readBytes( 0u );
...
// ---------------------------------------------------
	...
	AsynchronousFileWriter::BlockingResult Win32ContentProvider::AsynchronousFileAccessor::BlockUntilWriteComplete() {
		::DWORD			writtenBytes( 0u );
...
// ---------------------------------------------------
	...
	void Win32ContentProvider::AsynchronousFileAccessor::CancelRead() {
#	if( ETIsPlatform64Bit() )
...
// ---------------------------------------------------
	...
	void Win32ContentProvider::AsynchronousFileAccessor::CancelWrite() {
#	if( ETIsPlatform64Bit() )
...
// ---------------------------------------------------
	...
	uint64 Win32ContentProvider::AsynchronousFileAccessor::GetSizeInBytes() const {
...
// ---------------------------------------------------
	...
	size_t Win32ContentProvider::AsynchronousFileAccessor::GetMediaSectorSizeInBytes() const {
		return _mediaSectorSizeInBytes;
	}

// ---------------------------------------------------

	void Win32ContentProvider::AsynchronousFileAccessor::AdvanceToEnd() {
...
// ---------------------------------------------------
	...
	void Win32ContentProvider::AsynchronousFileAccessor::SetFileSize( uint64 fileSizeInBytes ) {
		::LARGE_INTEGER	fileOffsetHelper;
