...
namespace Configuration {
	...
	ConfigurationDatabase::ConfigurationDatabase( Allocator& allocator ) : _variableDirectory( 64u, allocator, UTF8L("Configuration Database Variable Directory Allocator") ) {}
