...
ETInlineHint constexpr Vector::Vector(float32 x, float32 y, float32 z, float32 w) :
	coefficients{ x, y, z, w } {}

// ---------------------------------------------------

ETInlineHint constexpr Vector::Vector(const float32* coefficients) :
	coefficients{ coefficients[0], coefficients[1], coefficients[2], coefficients[3] } {}

// ---------------------------------------------------

ETInlineHint constexpr Vector::Vector(const __m128& coefficients) :
...
ETInlineHint constexpr Vector ETSimdCall Vector::MakeIdentity() {
...
ETInlineHint constexpr Quaternion::Quaternion(float32 i, float32 j, float32 k, float32 w) :
	coefficients{ i, j, k, w } {}

// ---------------------------------------------------

ETInlineHint constexpr Quaternion::Quaternion(const float32* coefficients) :
	coefficients{ coefficients[0], coefficients[1], coefficients[2], coefficients[3] } {}

// ---------------------------------------------------

ETInlineHint constexpr Quaternion::Quaternion(const __m128& coefficients) :
	coefficients(coefficients) {}
...
ETInlineHint Quaternion ETSimdCall Quaternion::operator~() const {
	return GetReverse();
}
...
ETInlineHint constexpr Quaternion ETSimdCall Quaternion::MakeIdentity() {
...
ETInlineHint constexpr Transformation::Transformation(Vector translation, Quaternion rotation) :
	translation(translation),
	rotation(rotation) {}

// ---------------------------------------------------

ETInlineHint constexpr Transformation::Transformation(Vector translation) :
	Transformation(translation, Quaternion::MakeIdentity()) {}

// ---------------------------------------------------

ETInlineHint constexpr Transformation::Transformation(Quaternion orientation) :
...
ETInlineHint Transformation ETSimdCall Transformation::operator~() const {
	return GetInverse();
}

// ---------------------------------------------------

ETInlineHint constexpr Transformation ETSimdCall Transformation::MakeIdentity() {
