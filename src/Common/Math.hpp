...
template <typename T>
ETConstexpr ETPureFunctionHint ETNeverThrowsHint T Min(T lhs, T rhs);

// ---------------------------------------------------

template <typename T>
ETConstexpr ETPureFunctionHint ETNeverThrowsHint T Max(T lhs, T rhs);
...
ETConstexpr ETPureFunctionHint ETNeverThrowsHint uint32 AsIntBits(float32 value);
ETConstexpr ETPureFunctionHint ETNeverThrowsHint uint64 AsIntBits(float64 value);
