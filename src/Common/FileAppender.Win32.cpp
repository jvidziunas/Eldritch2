...
namespace {
	...
	FileAppender::FileAppender() : _file( INVALID_HANDLE_VALUE ) {}

// ---------------------------------------------------

	FileAppender::FileAppender( FileAppender&& appender ) : _file( eastl::exchange( appender._file, INVALID_HANDLE_VALUE ) ) {}
