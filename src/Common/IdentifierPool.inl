...
namespace Detail {
	...
	ETInlineHint IdentifierPool<Identifier>::ValueRange::ValueRange( IdentifierType first, IdentifierType last ) : first( first ), last( last ) {}
...
// ---------------------------------------------------
	...
	ETInlineHint IdentifierPool<Identifier, Allocator>::IdentifierPool( std::initializer_list<ValueRange> ranges, const AllocatorType& allocator ) : IdentifierPool( allocator ) {
...
// ---------------------------------------------------
	...
	template <typename Identifier, class Allocator>
	ETInlineHint IdentifierPool<Identifier, Allocator>::IdentifierPool( ValueRange initialRange, const AllocatorType& allocator ) : IdentifierPool( allocator ) {
...
// ---------------------------------------------------
	...
	template <typename Identifier, class Allocator>
	ETInlineHint IdentifierPool<Identifier, Allocator>::IdentifierPool( const AllocatorType& allocator ) : _freeRanges( allocator ) {}

// ---------------------------------------------------

	template <typename Identifier, class Allocator>
	ETInlineHint IdentifierPool<Identifier, Allocator>::IdentifierPool( IdentifierPool<Identifier, Allocator>&& pool ) : _freeRanges( eastl::move( pool._freeRanges ) ) {}
