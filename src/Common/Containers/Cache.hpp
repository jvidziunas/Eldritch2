...
namespace Eldritch2 {
	...
	//!	Retrieves a @ref ConstIterator to the first element stored in this @ref Cache.
		ConstIterator		ConstBegin() const;
	
		ConstLocalIterator	ConstEnd( SizeType bucketIndex ) const;
	//!	Retrieves a @ref ConstIterator to one past the end of all elements stored in this @ref Cache.
	...
	//!	Retrieves an @ref Iterator to the first element stored in this @ref Cache.
		Iterator			Begin();
	...
	//!	Retrieves an @ref Iterator to one past the end of all elements stored in this @ref Cache.
		Iterator			End();
