...
// ---------------------------------------------------
	...
	template <typename Value, typename SortPredicate, class Allocator>
	ETInlineHint ArraySet<Value, SortPredicate, Allocator>::ArraySet( const AllocatorType& allocator ) : _container( allocator ) {}
...
// ---------------------------------------------------
	...
	template <typename Value, typename SortPredicate, class Allocator>
	template <class /*SFINAE*/>
	ETInlineHint ArraySet<Value, SortPredicate, Allocator>& ArraySet<Value, SortPredicate, Allocator>::operator=( const ArraySet<Value, SortPredicate, Allocator>& set ) {
...
// ---------------------------------------------------
	...
	template <typename Value, typename SortPredicate, class Allocator>
	ETInlineHint ArraySet<Value, SortPredicate, Allocator>& ArraySet<Value, SortPredicate, Allocator>::operator=( ArraySet<Value, SortPredicate, Allocator>&& set ) {
		_container = eastl::move( set._container );
