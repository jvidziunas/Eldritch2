...
namespace Eldritch2 {
	...
	ETInlineHint ArrayList<Value, Allocator>::ArrayList(
		const ArrayList<Value, Allocator>& list
...
// ---------------------------------------------------
	...
	template <typename Value, typename Allocator>
	ETInlineHint ArrayList<Value, Allocator>::ArrayList(
		ArrayList<Value, Allocator>&& list
...
// ---------------------------------------------------
	...
	template <typename Value, typename Allocator>
	ETInlineHint void ArrayList<Value, Allocator>::Assign( ConstPointer begin, ConstPointer end ) {
