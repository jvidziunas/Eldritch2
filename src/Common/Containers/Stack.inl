...
namespace Eldritch2 {
	...
	ETInlineHint Stack<Value, Container>::Stack( const Stack<Value, Container>& stack, const AllocatorType& allocator ) : c( stack.c, allocator ) {}

// ---------------------------------------------------

	template <typename Value, class Container>
	template <class AllocatorType>
	ETInlineHint Stack<Value, Container>::Stack( Stack&& stack, const AllocatorType& allocator ) : c( eastl::move( stack.c ), allocator ) {}

// ---------------------------------------------------

	template <typename Value, class Container>
	template <class AllocatorType>
	ETInlineHint Stack<Value, Container>::Stack( const AllocatorType& allocator ) : c( allocator ) {}

// ---------------------------------------------------

	template <typename Value, class Container>
	ETInlineHint Stack<Value, Container>::Stack( const ContainerType& stack ) : c( stack ) {}

// ---------------------------------------------------

	template <typename Value, class Container>
	ETInlineHint Stack<Value, Container>::Stack( ContainerType&& stack ) : c( eastl::move( stack ) ) {}
