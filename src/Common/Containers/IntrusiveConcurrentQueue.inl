...
namespace Detail {
	...
	IntrusiveConcurrentQueue<Value, ElementPolicy>::IntrusiveConcurrentQueue( IntrusiveConcurrentQueue<Value, ElementPolicy>&& queue ) : ElementPolicy( eastl::move( queue ) ) {}
