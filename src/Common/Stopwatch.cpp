...
namespace Eldritch2 {
	...
	Stopwatch::Stopwatch( CpuTimestamp start ) : _start( start ) {}

// ---------------------------------------------------

	Stopwatch::Stopwatch( const Stopwatch& stopwatch ) : Stopwatch( stopwatch.GetStartTimestamp() ) {}

// ---------------------------------------------------

	Stopwatch::Stopwatch() : Stopwatch( ReadCpuTimestamp() ) {}
