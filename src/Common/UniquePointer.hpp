...
// ---------------------------------------------------
	...
	UniquePointer<Object, InstanceDeleter>			CreateUnique( Allocator& allocator, Args&&... args );

	template <typename Object, typename... Args>
	UniquePointer<Object[], InstanceArrayDeleter>	CreateUniqueArray( Allocator& allocator, size_t arraySizeInElements, Args&&... args );

	template <typename Object, typename Iterator>
	UniquePointer<Object[], InstanceArrayDeleter>	CreateUniqueArray( Allocator& allocator, Iterator firstElement, Iterator lastElement );
