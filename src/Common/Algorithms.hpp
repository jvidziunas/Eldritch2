...
namespace Eldritch2 {
	...
	public:
		...
		ETInlineHint void operator()( ObjectType& object ) const { object.~ObjectType(); }

		template <typename ObjectType>
		ETInlineHint void operator()( ObjectType* const object ) const { object->~ObjectType(); }
	};
...
// ---------------------------------------------------
	...
	public:
		template <typename ObjectType>
		ETInlineHint void operator()( ObjectType& object ) const { new( &object ) ObjectType(); }

		template <typename ObjectType>
		ETInlineHint void operator()( ObjectType* const object ) const { new( object ) ObjectType(); }
	};
