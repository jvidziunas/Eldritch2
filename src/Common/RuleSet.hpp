...
// ---
	...
	public:
		...
		using Rule				= Pair<Response, ArrayMap<SymbolType, Function<bool ( const QueryFact<SymbolType>& )>>>;
		using AllocatorType		= Allocator;
	...
	public:
		...
		MatchList<TemporaryAllocator>	MatchAll( const TemporaryAllocator& allocator, UnaryPredicate queryBuilder ) const;

		template <class TemporaryAllocator, typename UnaryPredicate>
		RuleIterator					Match( const TemporaryAllocator& allocator, UnaryPredicate queryBuilder ) const;

	// ---------------------------------------------------

	public:
		template <typename UnaryPredicate>
		void	InsertRule( Response response, UnaryPredicate ruleBuilder );
