...
namespace Detail {
	...
	template <typename T>
	void DeleterFunction( Allocator& allocator, void* objects, size_t objectCount ) {
...
// ---------------------------------------------------
	...
	template <typename T>
	void DeleterFunction( Allocator& allocator, void* object ) {
	...
	ETInlineHint InstanceDeleter::InstanceDeleter(
		...
		_object( object ),
		_deleterFunction( Detail::DeleterFunction<T> ) {}

// ---------------------------------------------------

	ETInlineHint InstanceDeleter::InstanceDeleter() : _allocator( nullptr ), _deleterFunction( [] ( Allocator&, void* ) {} ) {}
...
// ---------------------------------------------------
	...
	ETInlineHint void InstanceDeleter::operator()( T* const object ) const {
		...
		_deleterFunction( *_allocator, _object );
	}
...
// ---------------------------------------------------
	...
	ETInlineHint InstanceArrayDeleter::InstanceArrayDeleter() : _countInObjects( 0u ), _allocator( nullptr ), _deleter( [] ( Allocator&, void*, size_t ) {} ) {}
