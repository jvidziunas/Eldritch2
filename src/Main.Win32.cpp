...
namespace {
	...
	public:
		int EntryPoint() {
			return _scheduler.Boot( Max( GetCoreInfo().physicalCores, 2u ) - 1u, [this] ( JobExecutor& executor ) {
				MicroProfileInit();

				_scheduler.SetShouldShutDown(
